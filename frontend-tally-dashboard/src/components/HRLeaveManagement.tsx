        ...
        {leaveSummary.map((card, index) => (
          <div key={index} className={`${card.color} p-5 rounded-lg shadow-sm border border-gray-100`}>
            ...
            <div className="flex items-end justify-between">
              ...
              <span className={`${card.trendUp ? 'text-green-500' : 'text-gray-500'} text-sm flex items-center`}>
          ...
          <div className="flex items-center gap-3">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search..."
                className="pl-9 pr-3 py-2 border border-gray-200 rounded-md text-sm focus:outline-none focus:border-blue-500"
                value={searchTerm}
                  ...
                  <td className="px-4 py-3 text-right">
                    {request.status === 'pending' ? (
                      <div className="flex justify-end space-x-2">
                        <button className="text-xs px-2 py-1 bg-green-50 text-green-600 hover:bg-green-100 rounded">
                          Approve
                        </button>
